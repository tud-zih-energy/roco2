...
#
# Found at: https://github.com/hanjianwei/cmake-modules
...
set(INTEL_ROOT "${MKL_ROOT}/../" CACHE PATH "Folder contains intel libs")
...
if(MKL_SDL)
    ...
    PATHS ${MKL_ROOT}/lib
    PATH_SUFFIXES ia32 intel64 ia64)
    ...
    mark_as_advanced(MKL_THREADING_LIBRARY)
    mark_as_advanced(MKL_CORE_LIBRARY)
    mark_as_advanced(MKL_FFT_LIBRARY)
...
if(MKL_FOUND)
    ...
    mark_as_advanced(MKL_INCLUDE_DIRS MKL_LIBRARIES MKL_MINIMAL_LIBRARIES)
endif()
